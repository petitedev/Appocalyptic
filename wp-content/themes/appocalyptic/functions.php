<?php
/**
 * appocalyptic functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package appocalyptic
 */
...
if ( ! function_exists( 'appocalyptic_setup' ) ) :
	/**
	 ...
	 */
	function appocalyptic_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on appocalyptic, use a find and replace
		 * to change 'appocalyptic' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'appocalyptic', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'appocalyptic' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'appocalyptic_custom_background_args', array(
...
add_action( 'after_setup_theme', 'appocalyptic_setup' );
 ...
 */
function appocalyptic_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'appocalyptic_content_width', 640 );
}
add_action( 'after_setup_theme', 'appocalyptic_content_width', 0 );
 ...
 */
function appocalyptic_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'appocalyptic' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'appocalyptic' ),
...
add_action( 'wp_enqueue_scripts', 'appocalyptic_scripts' );
